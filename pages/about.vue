<template>
  <div class="About">
    ...
    <TextCard>
      当サイトは、山梨県の新型コロナウイルス感染症（COVID-19）に関する最新情報を提供するために開設したものです。開発は、山梨県内の有志によって結成された「stopcovid19.yamanashi.dev」チームが行っています。<br />
      <br />
    ...
    <TextCard title="免責事項">
      当サイトに掲載されている情報については、山梨県によって公開されたデータですが、山梨県および当サイトの開発者・関係者は、利用者が当サイトの情報を用いて行う一切の行為について責任を負うものではありません。<br />
      <br />
    ...
    <TextCard title="ソースコードについて">
      ...
      <a
        ...
        target="_blank"
        rel="noopener"
        >東京都 新型コロナウイルス感染症対策サイト</a
      >」で使われているものをMITライセンスの元で再使用しています。このソースコードは誰でも自由に利用することができます。詳しくは、
      <a
